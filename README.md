...
The DCCTrainThrottle is a simple DIY, handheld controller that talks to a wThrottle Server (JMRI, DCC++EX and many others) using the wiThrottle protocol to control DCC model trains. 
...
3. A wiThrottle Server to connect to. DCCTrainThrottle will work with any wiThrottle Server. e.g.
...
![Assembly diagram](DCCTrainThrottle%20pinouts%20v0.1.png)
...
3. Download or clone *this* repository. (Note: if you 'clone' initially, it is easier to receive updates to the code by doing a 'fetch' subsequently.  See Notes below.)
    * Clone - **First Time**
       ...
       * Enter *https://github.com/TheOneTheProdigy/DCCTrainThrottle* as the URL
    ...
    * Download 
       * Open *https://github.com/TheOneTheProdigy/DCCTrainThrottle*
...
Notes: 
   * DCCTrainThrottle version 1.19 or later requires WiThrottleProtocol version 1.1.3 or later.
   * DCCTrainThrottle version 1.06 or later requires WiThrottleProtocol version 1.1.2 or later.
   * DCCTrainThrottle version 1.01 or later requires WiThrottleProtocol version 1.1.0 or later.
   * DCCTrainThrottle version 0.10 or later requires WiThrottleProtocol version 1.0.3 or later.
   ...
   * To get the DCCTrainThrottle sketch I recommend using either the git command line, or the far more friendly 'GitHub Desktop' app.  See instructions above.
