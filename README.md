...
The DCC-Loco-Throttle is a simple DIY, handheld controller that talks to a wThrottle Server (JMRI, DCC++EX and many others) using the wiThrottle protocol to control DCC model trains. 
...
3. A wiThrottle Server to connect to. DCC-Loco-Throttle will work with any wiThrottle Server. e.g.
...
![Assembly diagram](DCC-Loco-Throttle%20pinouts%20v0.1.png)

*Pinouts for Optional Additional Buttons*
![Assembly diagram - Optional Additional Buttons](DCC-Loco-Throttle%20-%20Optional%20Buttons%20-%20pinouts%20v0.1.png)
...
3. Download or clone *this* repository. (Note: if you 'clone' initially, it is easier to receive updates to the code by doing a 'fetch' subsequently.  See Notes below.)
    * Clone - **First Time**
       ...
       * Enter *https://github.com/TheOneTheProdigy/DCC-Loco-Throttle* as the URL
    ...
    * Download 
       * Open *https://github.com/TheOneTheProdigy/DCC-Loco-Throttle*
...
Notes: 
   * DCC-Loco-Throttle version 1.19 or later requires WiThrottleProtocol version 1.1.3 or later.
   * DCC-Loco-Throttle version 1.06 or later requires WiThrottleProtocol version 1.1.2 or later.
   * DCC-Loco-Throttle version 1.01 or later requires WiThrottleProtocol version 1.1.0 or later.
   * DCC-Loco-Throttle version 0.10 or later requires WiThrottleProtocol version 1.0.3 or later.
   ...
   * To get the DCC-Loco-Throttle sketch I recommend using either the git command line, or the far more friendly 'GitHub Desktop' app.  See instructions above.
